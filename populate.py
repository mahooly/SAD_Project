            ...
            if counter < n and len(Benefactor.objects.filter(user=u)) == 0:
                 try:
                    Benefactor.objects.create(user=u, name=first_name,
                                              ...
                                              wId_id=WeeklySchedule.objects.create(c2=random.choice(['on','off']),c1=random.choice(['on','off']),c3=random.choice(['on','off']),c21=random.choice(['on','off']),c12=random.choice(['on','off']),c17=random.choice(['on','off'])).id,
                                              rate_id=TotalRate.objects.create(totalRate=random.randint(0, 100),
                                                                               f1=random.randint(0, 100),f2=random.randint(0, 100),f3=random.randint(0, 100),f4=random.randint(0, 100),f5=random.randint(0, 100)).id)
                    counter += 1
                    print('ben make done')
                    break
...
def make_ability(n):
    ...
    for _ in range(n):
        name=random.choice(['خیاطی','کارگری','جوشکاری','کفاشی','منابع انسانی','مدریت راهبردی','معلم','مکانیک','پزشکی','آتش نشان','نگهبان','برق کار'])
